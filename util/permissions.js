module.exports = {
  ...
  checkMod(message) {
    try {
      ...
      else if(!message.channel.memberHasPermission(message.author.id, "Administrator") && !message.channel.memberHasPermission(message.author.id, "kickMembers") && !message.channel.memberHasPermission(message.author.id, "manageMessages")) return false;
      else return true;
    } catch(e) {
      throw e;
    }
